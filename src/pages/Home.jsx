...
const categories = [
    { name: 'Blouse', img: 'https://images.unsplash.com/photo-1519748771451-a94c596fad67?w=500' }, // New Saree Blouse image
    { name: 'Kurta', img: 'https://images.unsplash.com/photo-1581044777550-4cfa60707c03?w=500' }, // Reusing working Salwar image which looks like Kurta
    { name: 'Lehenga', img: 'https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=500' },
    { name: 'Gown', img: 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?w=500' },
    { name: 'Salwar', img: 'https://images.unsplash.com/photo-1582562124811-c09040d0a901?w=500' }, // New Salwar image
    { name: 'Western', img: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=500' }, // New Western Dress image
];
    ...
    return (
        <div className="bg-white min-h-screen pb-12">
            ...
            <div className="section-container pt-16">
                ...
                <Row gutter={[24, 24]}>
                    {[
                        { name: 'BLOUSE', img: 'https://images.unsplash.com/photo-1519748771451-a94c596fad67?w=600&h=800&fit=crop' },
                        { name: 'KURTI', img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=600&h=800&fit=crop' },
                        { name: 'SALWAR KAMEEZ', img: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&h=800&fit=crop' },
                        { name: 'LEHENGA', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=600&h=800&fit=crop' },
                        { name: 'DRESS', img: 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&h=800&fit=crop' },
                    ...
                    <Row gutter={48} align="middle">
                        ...
                        <Col xs={24} md={12} className="hidden md:block">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <img src="https://images.unsplash.com/photo-1520004434532-668416a08753?w=600" className="rounded-lg shadow-lg" />
                            </div>
                        </Col>
                    </Row>
                </div>
